...
import { Play, Pause, SkipBack, SkipForward, Clock, Music, Calendar, User, Disc, Volume2 } from 'lucide-react';
            ...
            <div className="flex items-center">
              ...
              <div className="flex-1 mr-4">
                ...
                <div className="text-gray-400 text-sm truncate">
                  {tracks[currentTrackIndex]?.strArtist || album.strArtist || 'Unknown Artist'}
                </div>
                {audioError && (
              ...
              <div className="flex items-center space-x-4">
                ...
                <button 
                  onClick={playNext}
                  disabled={currentTrackIndex === tracks.length - 1 || isSearchingAudio}
                  className="text-gray-400 hover:text-white disabled:opacity-50"
                >
                                  <SkipForward size={24} />
                </button>
              ...
              >
                <div className="w-8 text-center text-gray-500 mr-4">
                  {currentTrackIndex === index ? (
                    <button onClick={togglePlayPause} disabled={isSearchingAudio}>
                      {isSearchingAudio ? (
